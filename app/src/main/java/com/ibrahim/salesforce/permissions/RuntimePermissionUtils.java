...
package com.ibrahim.salesforce.permissions;
...
public final class RuntimePermissionUtils {
    ...
    private static boolean hasSelfPermissionForXiaomi(Context context, String permission) {
        ...
        return noteOp == AppOpsManagerCompat.MODE_ALLOWED && checkSelfPermission(context, permission) == PermissionChecker.PERMISSION_GRANTED;
    }
