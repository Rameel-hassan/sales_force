...
import com.ibrahim.salesforce.adapters.AdapterShowProducts
import com.ibrahim.salesforce.adapters.AssignProductsAdapter
import com.ibrahim.salesforce.adapters.SampleDetailsAdapter
import com.ibrahim.salesforce.adapters.SubjectsAndClassesAdapter
import com.ibrahim.salesforce.adapters.TargetedSchoolsAdapter
import com.ibrahim.salesforce.databinding.ActivityAddTargetedSchoolBinding
import com.ibrahim.salesforce.databinding.DbAssignProductBinding
import com.ibrahim.salesforce.databinding.DbShowProductsBinding
import com.ibrahim.salesforce.model.SampleSearchModel
import com.ibrahim.salesforce.model.SubjectAndClassesModel
...
//            areaSearch = intent.getIntExtra("areaId", 0)
    ...
    private fun setWorkingPrioritySpinner() {
        val adapter = ArrayAdapter.createFromResource(
            ...
            com.ibrahim.salesforce.R.array.working_priority, R.layout.simple_spinner_dropdown_item
        )
    ...
    private fun setCitySpinner() {
        ...
        binding.spnCity.setOnTouchListener(View.OnTouchListener(fun(
            ...
            if (event.action == MotionEvent.ACTION_UP) {
                ...
                temp.searchBox.setTextColor(resources.getColorStateList(com.ibrahim.salesforce.R.color.innercolor))
